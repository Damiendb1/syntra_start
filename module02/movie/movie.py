...
def create_movie(movie_info: dict)->Movie:
    genre = (movie_info.get("genre") or "").strip()
    ...
    release_date = _parse_date(movie_info.get("Original_release_date"))
    streaming_date = _parse_date(movie_info.get("release_date_date"))
    length = _parse_int(movie_info.get("runtime"))
